...
export const IMAGE_COMPRESS = {
  name: 'Image图片压缩',
  url: 'https://github.com/shaoshaui/vue3-vite-ts-vueRouter-pinia-antDesign/blob/main/src/views/image/image-compress.tsx',
...
export const COUNTTO_PLUGIN = {
  name: 'CountTo数字滚动',
  url: 'https://github.com/shaoshaui/vue3-vite-ts-vueRouter-pinia-antDesign/blob/main/src/components/CountTo/src/index.tsx',
